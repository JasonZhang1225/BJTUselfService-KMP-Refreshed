...
> 阶段状态：**1.7.6-KMP 已正式发布；安全审计修复已提交（`edbfa55`）；2026-09-18 屎山修复里程碑全部完成并提交（`1409ba0`，P0/P1/P2a/P2b部分/P3，净删约 2900 行，本地 DMG/IPA 实机通过），审计与进度见 `docs/refactor/BJTU-KMP-CodeShit-Audit-GLM-2026-09-17.md` 第九节。** 邮箱主体能力保持自 `v1.7.5-KMP`，真实邮箱写操作、Apple 真机签名等仍按已知限制保留。
